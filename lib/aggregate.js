...
export function aggregateGrowth(datasets, schoolRegionIndex, { now = new Date() } = {}) {
  ...
  // its own exclusion logic. B-less additionally keeps only real
  // membership-ending rows (see isEndingMembership above) — a paused or
  // moved membership isn't a B-less.
  const filteredDatasets = {
    ...
    bless: excludeFootball(datasets.bless, schoolRegionIndex).filter(isEndingMembership),
  };
